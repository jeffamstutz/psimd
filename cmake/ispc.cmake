...
MACRO (PSIMD_ISPC_COMPILE)
  SET(ISPC_ADDITIONAL_ARGS "")
  SET(ISPC_TARGETS ${PSIMD_ISPC_TARGET_LIST})
...
MACRO(PSIMD_CONFIGURE_ISPC_ISA)
  SET(PSIMD_BUILD_ISA "AVX" CACHE STRING
      "Target ISA (SSE4, AVX, AVX2, AVX512KNL, AVX512SKX)")
  STRING(TOUPPER ${PSIMD_BUILD_ISA} PSIMD_BUILD_ISA)
  SET_PROPERTY(CACHE PSIMD_BUILD_ISA PROPERTY STRINGS
               SSE4 AVX AVX2 AVX512KNL AVX512SKX)

  UNSET(PSIMD_ISPC_TARGET_LIST)

  IF (PSIMD_BUILD_ISA STREQUAL "AVX512SKX")
    SET(PSIMD_ISPC_TARGET_LIST avx512skx-i32x16)
  ELSEIF (PSIMD_BUILD_ISA STREQUAL "AVX512KNL")
    SET(PSIMD_ISPC_TARGET_LIST avx512knl-i32x16)
  ELSEIF (PSIMD_BUILD_ISA STREQUAL "AVX2")
    SET(PSIMD_ISPC_TARGET_LIST avx2)
  ELSEIF (PSIMD_BUILD_ISA STREQUAL "AVX")
    SET(PSIMD_ISPC_TARGET_LIST avx)
  ELSEIF (PSIMD_BUILD_ISA STREQUAL "SSE4")
    SET(PSIMD_ISPC_TARGET_LIST sse4)
  ELSE ()
    MESSAGE(ERROR "Invalid PSIMD_BUILD_ISA value. "
                  "Please select one of ${PSIMD_SUPPORTED_ISAS}")
  ENDIF()
ENDMACRO()
...
MACRO(ISPC_ADD_EXECUTABLE name)
  ...
  FOREACH(src ${ARGN})
    ...
    ENDIF ()
  ENDFOREACH()
  PSIMD_ISPC_COMPILE(${ISPC_SOURCES})
